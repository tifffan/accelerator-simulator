...
#SBATCH --job-name=eval_cgnv0_50
#SBATCH --output=logs/20250608/eval_cgnv0_50_%j.out
#SBATCH --error=logs/20250608/eval_cgnv0_50_%j.err
#SBATCH --ntasks=1
...
results_folder="results/$run_name/eval_at_50"
