...
#SBATCH --output=logs/cgnv0_archive5/test_cgnv0_%j.out
#SBATCH --error=logs/cgnv0_archive5/test_cgnv0_%j.err
#SBATCH --ntasks=1
...
DATASET="sequence_graph_data_archive_5_1280"
DATA_KEYWORD="knn_k5_unweighted"
BASE_DATA_DIR="/sdf/data/ad/ard/u/tiffan/data"
BASE_RESULTS_DIR="/sdf/data/ad/ard/u/tiffan/sequence_results_global"
BATCH_SIZE=16
LR=1e-3
HIDDEN_DIM=128
NUM_LAYERS=6
