...
#SBATCH --job-name=eval_seq_10_76_20250417
#SBATCH --output=logs/eval_seq_10_76_20250417_%j.out
#SBATCH --error=logs/eval_seq_10_76_20250417_%j.err
#SBATCH --ntasks=1
...
python_command="src/graph_simulators/evaluate_kde_filtering.py \
    ...
    --results_folder /sdf/home/t/tiffan/repo/accelerator-simulator/results/20250417_rollout_10_76
"
