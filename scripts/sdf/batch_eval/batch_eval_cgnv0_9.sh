...
#SBATCH --job-name=eval_cgnv0_focus
#SBATCH --output=logs/20250608/eval_cgnv0_focus_%j.out
#SBATCH --error=logs/20250608/eval_cgnv0_focus_%j.err
#SBATCH --ntasks=1
...
EVAL_SCRIPT="src/graph_simulators/evaluate_20250609.py"

mkdir -p logs
mkdir -p results

# Only evaluate the specific run/folder
run_name="sequence_graph_data_archive_4/seq_init5_final76/knn_k5_weighted_r0_nt128_nv16_b8_lr1e-03_h256_ly6_df1.00_hor3_nl0.0_ep3000_pr1.00_sch_exp_0.001_100_pos_sinusoidal"
...
results_folder="results/$run_name/eval_at_5"
...
python "$EVAL_SCRIPT" \
  --model cgnv0 \
  --dataset sequence_graph_data_archive_4_test \
