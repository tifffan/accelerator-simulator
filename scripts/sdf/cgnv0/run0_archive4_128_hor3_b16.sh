...
#SBATCH --output=logs/cgnv0_archive4/cgnv0_128_hor1_%j.out
#SBATCH --error=logs/cgnv0_archive4/cgnv0_128_hor1_%j.err
#SBATCH --ntasks=1
...
INITIAL_STEP=5
FINAL_STEP=76
CHECKPOINT_PATH="/sdf/data/ad/ard/u/tiffan/sequence_results/cgnv0/sequence_graph_data_archive_4_160_train/seq_init5_final76/knn_k5_weighted_r0_nt8832_nv1104_b16_lr1e-03_h128_ly6_df1.00_hor3_nl0.0_ep1000_pr1.00_sch_exp_0.0001_100_pos_sinusoidal/checkpoints/best_model.pth"
