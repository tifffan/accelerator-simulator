...
python_command="src/graph_simulators/evaluate_v3_reduced.py \
    --model scgn \
    ...
    --horizon 1 \
    --random_seed 63 \
    --checkpoint /sdf/data/ad/ard/u/tiffan/sequence_results/scgn/sequence_graph_data_archive_4/seq_init0_final76/knn_k5_weighted_r63_nt80_nv10_b16_lr1e-03_h256_ly6_df0.90_hor1_nl0.0_lam1.0_ep1000_pr1.00_sch_lin_40_4000_1e-05/checkpoints/model-100.pth
"
