#!/usr/bin/env python
"""
evaluate_20250610.py

This script performs evaluation of a trained CGNV0 model on test and training datasets.
...
The script iterates over all test and train samples. For each sample, it:
...
All generated figures are saved with filenames that include the sample index and data source (train/test).

Usage:
    python evaluate_20250610.py --model cgnv0 --data_keyword sequence_graph --dataset my_dataset \
