...
#SBATCH --job-name=eval_seq_1_4
#SBATCH --output=logs/eval_seq_1_4_%j.out
#SBATCH --error=logs/eval_seq_1_4_%j.err
#SBATCH --ntasks=1
...
python_command="src/graph_simulators/evaluate_20250224.py \
    ...
    --horizon 1 \
    --random_seed 63 \
    --checkpoint /sdf/home/t/tiffan/repo/accelerator-simulator/knn_k5_weighted_r63_nt80_nv10_b16_lr1e-03_h128_ly6_df1.00_hor1_nl0.0_lam1.0_ep3000_pr1.00_sch_lin_40_400_1e-04/checkpoints/best_model.pth \
    --results_folder /sdf/home/t/tiffan/repo/accelerator-simulator/results/20250225_rollout
"
