...
#SBATCH --job-name=eval_fieldmap_1_4
#SBATCH --output=logs/20250522/eval_fieldmap_1_4_%j.out
#SBATCH --error=logs/20250522/eval_fieldmap_1_4_%j.err
#SBATCH --ntasks=1
...
python_command="src/graph_simulators/evaluate_20250224.py \
    --model scgn \
    ...
    --position_encoding_method fieldmaps \
    ...
    --noise_level 0.05 \
    --random_seed 63 \
    --checkpoint /sdf/home/t/tiffan/repo/accelerator-simulator/20250525/seq_init30_final35/knn_k5_weighted_r63_nt800_nv100_b16_lr1e-03_h128_ly6_df1.00_hor3_nl0.05_lam1.0_ep1000_pr1.00_sch_lin_40_400_1e-04_pos_fieldmaps_scaling/checkpoints/best_model.pth \
    --results_folder /sdf/home/t/tiffan/repo/accelerator-simulator/results/20250525_rollout_30_35_fieldmap_hor3_noise005 \
"
