...
def compute_global_mean_and_max(data_catalog, output_file='global_mean_max.txt'):
    # Load data catalog
    ...
    print(f"Global mean and max saved to {output_file}")
...
if __name__ == "__main__":
    ...
    compute_global_mean_and_max(
        data_catalog, 
        output_file='/sdf/home/t/tiffan/repo/accelerator-surrogate/src/preprocessing/global_mean_max_vary_distributions_vary_settings_filtered_total_charge_51_catalog_all_sdf_cleaned.txt'
    )
