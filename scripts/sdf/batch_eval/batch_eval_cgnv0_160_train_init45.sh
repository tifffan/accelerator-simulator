...
#SBATCH --job-name=eval_cgnv0_45
#SBATCH --output=logs/20250608/eval_cgnv0_45_%j.out
#SBATCH --error=logs/20250608/eval_cgnv0_45_%j.err
#SBATCH --ntasks=1
...
results_folder="results/$run_name/eval_at_45"
