...
#SBATCH --job-name=eval_cgnv0_30
#SBATCH --output=logs/20250608/eval_cgnv0_30_%j.out
#SBATCH --error=logs/20250608/eval_cgnv0_30_%j.err
#SBATCH --ntasks=1
...
results_folder="results/$run_name/eval_at_30"
