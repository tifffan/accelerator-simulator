...
python_command="src/graph_simulators/train.py     --model scgn     --dataset sequence_graph_data_archive_4     --data_keyword knn_k5_weighted     --base_data_dir /pscratch/sd/t/tiffan/data     --base_results_dir /pscratch/sd/t/tiffan/sequence_results     --initial_step 0     --final_step 76     --include_settings     --identical_settings     --include_position_index     --include_scaling_factors     --scaling_factors_file /global/homes/t/tiffan/repo/accelerator-simulator/data/sequence_particles_data_archive_4_global_statistics.txt     --use_edge_attr     --ntrain 80     --nval 10     --ntest 10     --batch_size 16     --lr 1e-3     --hidden_dim 128     --num_layers 6     --discount_factor 1.0     --horizon 1     --nepochs 3000     --noise_level 0.0     --lambda_ratio 1.0     --lr_scheduler lin     --lin_start_epoch 40     --lin_end_epoch 400     --lin_final_lr 1e-4     --random_seed 63       --checkpoint /pscratch/sd/t/tiffan/sequence_results/scgn/sequence_graph_data_archive_4/seq_init0_final76/knn_k5_weighted_r63_nt80_nv10_b16_lr1e-03_h128_ly6_df1.00_hor1_nl0.0_lam1.0_ep2800_pr1.00_sch_lin_40_400_1e-04/checkpoints/model-2800.pth"
